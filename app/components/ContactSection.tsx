...
export default function ContactSection() {
  return (
    <section id="contact" className="ppy-12 md:py-20 bg-gradient-to-b from-purple-bright/5 to-black">
...
const ContactButtons = () => (
  ...
  >
    ...
    <ContactButton 
      href="/resume.pdf" 
      iconPath="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z M8 11a1 1 0 100 2h4a1 1 0 100-2H8z M8 7a1 1 0 100 2h4a1 1 0 100-2H8z"
      text="Resume"
      target="_blank"
    />
  </motion.div>
